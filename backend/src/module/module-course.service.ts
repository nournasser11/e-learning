...
export class ModulesService {
  ...
  async addQuestion(
    ...
    return module;
  }async getModuleContent(courseId: string, moduleId: string) {
    console.log('Fetching module content for course:', courseId, 'and module ID:', moduleId); // Debug log
  
    if (!mongoose.Types.ObjectId.isValid(courseId) || !mongoose.Types.ObjectId.isValid(moduleId)) {
      throw new BadRequestException('Invalid courseId or moduleId format.');
    }
