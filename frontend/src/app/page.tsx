...
const HomePage = () => {
  ...
  return (
    <Layout>
      {/* Full Page Container */}
      <div className="relative min-h-screen bg-black text-white px-4 py-8">
        {/* Top Right Buttons */}
        <div className="absolute top-4 right-4 flex space-x-2">
          ...
          <motion.button
            ...
            className="bg-gray-800 hover:bg-gray-700 text-blue-400 font-semibold py-1 px-3 rounded text-xs border border-gray-600"
          >
            Create an Account
          </motion.button>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          >
            Learn Anything From Anywhere with E-Learn
          </motion.h1>
          <motion.p
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400">&copy; 2024 E-Learn. All rights reserved.</p>
        </div>
      </div>
    </Layout>
  );
